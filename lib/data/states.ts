...
export const statesData: Record<string, StateData> = {
  assam: {
    ...
    heroImage: cloudinaryUrl("assam-hero1.jpg"), // Kaziranga/Rhino placeholder
    ...
    popularDestinations: [
      {
        ...
        image: cloudinaryUrl("kaziranga-national-park.jpg"), // Rhino
      ...
      {
        name: "Majuli Island",
        image: cloudinaryUrl("neland.jpg"), // River/Boat/Island
      ...
      },
      {
        ...
        image: cloudinaryUrl("northeast-tour-highlight-2.jpg"), // Temple/Culture
      ...
      },
      {
        ...
        image: cloudinaryUrl("jorhat-tea.jpg"), // Tea Gardens
    ...
    culture: {
      ...
      images: [
        cloudinaryUrl("bihu.jpg"), 
        cloudinaryUrl("northeast-tour-highlight-1.jpg"),
        cloudinaryUrl("northeast-tour-highlight-4.jpg"),
        cloudinaryUrl("northeast-tour-highlight-6.jpg")
      ],
  ...
  meghalaya: {
    ...
    heroImage: cloudinaryUrl("meghalaya-tourism-clouds.jpg"), // Nohkalikai Falls
    ...
    popularDestinations: [
      {
        name: "Shillong",
        image: cloudinaryUrl("shillong-1.jpg"), // Shillong
      ...
      },
      {
        ...
        image: cloudinaryUrl("northeast-tour-highlight-2-3.jpg"), // Cherrapunji/Nohkalikai
      ...
      },
      {
        ...
        image: cloudinaryUrl("meghalaya-dawki-river.jpg"), // Clear river
      ...
      {
        name: "Mawlynnong",
        image: cloudinaryUrl("Mawlynnong.jpg"), // Clean Village/Nature
    ...
    culture: {
      ...
      images: [
        cloudinaryUrl("northeast-tour-highlight-2-6.jpg"), // Placeholder for tribal fest
        cloudinaryUrl("caves.jpg"), // Placeholder nature/culture
        cloudinaryUrl("khasi.jpg"), // People/Music
        cloudinaryUrl("Wari-chora.jpg")  // Landscape culture
      ],
  ...
  arunachal: {
    ...
    heroImage: cloudinaryUrl("northeast-tour-highlight-3-1.jpg"), // Needs mountain/monastery placeholder
    ...
    popularDestinations: [
      {
        name: "Tawang",
        image: cloudinaryUrl("arunachal-pradesh-landscape.jpg"), // Mountain/Monastery
      ...
      {
        name: "Ziro Valley",
        image: cloudinaryUrl("ziro.jpg"), // Green Valley/Paddy
      ...
      {
        name: "Dirang",
        image: cloudinaryUrl("arunachal-pradesh-unseen-beauty.jpg"), // Valley
      ...
      },
      {
        ...
        image: cloudinaryUrl("Namdapha National Park.jpg"), // Dense forest/Tiger
    ...
    culture: {
      ...
      images: [
        cloudinaryUrl("adi.jpg"), 
        cloudinaryUrl("apatani.jpg"), 
        cloudinaryUrl("mechuka.jpg"), 
        cloudinaryUrl("1559127574-1559127559952.jpg")
      ],
  ...
  nagaland: {
    ...
    heroImage: cloudinaryUrl("nagaland-hero.jpg"), // placeholder
    ...
    popularDestinations: [
      {
        name: "Kohima",
        image: cloudinaryUrl("mon.png"), // Kohima placeholder
      ...
      {
        name: "Dzukou Valley",
        image: cloudinaryUrl("nagaland-dzuko-valley.jpg"), // Valley placeholder
      ...
      {
        name: "Mokokchung",
        image: cloudinaryUrl("Mokokchung.jpg"), // Mokokchung Placeholder
      ...
      {
        name: "Mon",
        image: cloudinaryUrl("mon.jpg"), // Tribe placeholder
    ...
    culture: {
      ...
      images: [
        cloudinaryUrl("angami.jpg"),
        cloudinaryUrl("naga.jpg"),
        cloudinaryUrl("nagaland-festival-tribes.webp"),
        cloudinaryUrl("warrior.webp")
      ],
  ...
  sikkim: {
    ...
    heroImage: cloudinaryUrl("sign.jpg"), // Needs Kanchenjunga
    ...
    popularDestinations: [
      {
        name: "Gangtok",
        image: cloudinaryUrl("gangtok.jpg"), // placeholder
      ...
      },
      {
        ...
        image: cloudinaryUrl("sikkim-monastery-kanchenjunga.jpg"), // snow placeholder
      ...
      },
      {
        ...
        image: cloudinaryUrl("sikkim-himalayan-destination.jpg"), // lake placeholder
      ...
      {
        name: "Pelling",
        image: cloudinaryUrl("pel.png"), // Kanchenjunga view
    ...
    culture: {
      ...
      images: [
        cloudinaryUrl("sik.jpeg"),
        cloudinaryUrl("dress.jpg"),
        cloudinaryUrl("northeast-tour-highlight-8-6.jpg"),
        cloudinaryUrl("mask.jpg")
      ],
  ...
  mizoram: {
    ...
    heroImage: cloudinaryUrl("mizoram-hero'.jpg"), // Placeholder
    ...
    popularDestinations: [
      {
        name: "Aizawl",
        image: cloudinaryUrl("aizawl.jpg"), // Aizawl placeholder
      ...
      {
        name: "Reiek Tlang",
        image: cloudinaryUrl("Reiek Tlang.jpg"), // Hill placeholder
      ...
      {
        name: "Champhai",
        image: cloudinaryUrl("Champhai.jpg"), // Champhai placeholder
      ...
      {
        name: "Vantawng Falls",
        image: cloudinaryUrl("Vantawng Falls.jpg"), // Waterfall placeholder
    ...
    culture: {
      ...
      images: [
        cloudinaryUrl("mizotribe.jpg"),
        cloudinaryUrl("mizoram-f1.jpg"),
        cloudinaryUrl("mizo-tribe.jpg"),
        cloudinaryUrl("626bcd981143c-beino-caslte-1.jpg")
      ],
  ...
  manipur: {
    ...
    heroImage: cloudinaryUrl("manipur-hero.jpg"), // Placeholder
    ...
    popularDestinations: [
      {
        name: "Imphal",
        image: cloudinaryUrl("imphal.jpg"), // Imphal
      ...
      },
      {
        ...
        image: cloudinaryUrl("loktak lake.png"), // Lake
      ...
      {
        name: "Ukhrul",
        image: cloudinaryUrl("Ukhrul.jpg"), // Ukhrul
      ...
      {
        name: "Moirang",
        image: cloudinaryUrl("Moirang.jpg"), // Moirang
    ...
    culture: {
      ...
      images: [
        cloudinaryUrl("manipur-t2.jpg"),
        cloudinaryUrl("manipur-loktak-lake.jpg"),
        cloudinaryUrl("manipur-jewel-of-india.webp"),
        cloudinaryUrl("manipur-t1.jpg")
      ],
  ...
  tripura: {
    ...
    heroImage: cloudinaryUrl("tripura-hero.jpg"), // Neermahal placeholder
    ...
    popularDestinations: [
      {
        name: "Agartala",
        image: cloudinaryUrl("agartala.jpg"), // placeholder
      ...
      {
        name: "Unakoti",
        image: cloudinaryUrl("Unakoti.jpg"), // rock carving placeholder
      ...
      },
      {
        ...
        image: cloudinaryUrl("Melaghar (Neermahal).jpg"), // lake palace placeholder
      ...
      {
        name: "Udaipur",
        image: cloudinaryUrl("Udaipur.jpg"), // temple placeholder
    ...
    culture: {
      ...
      images: [
        cloudinaryUrl("Tripura-t1.jpg"),
        cloudinaryUrl("tripura.jpg"),
        cloudinaryUrl("longwa.jpg"),
        cloudinaryUrl("tripura2.jpg")
      ],
